...
export function CtaBand({
  ...
  return (
    <section className="border-t border-line bg-palm-deep text-paper">
      <Container className="flex flex-col items-start justify-between gap-6 py-16 md:flex-row md:items-center">
        ...
        <Link
          href="/demo"
          className="rounded-full bg-paper px-6 py-3 text-sm font-semibold text-palm-deep hover:bg-leaf"
        >
          Book a demo
        </Link>
      </Container>
