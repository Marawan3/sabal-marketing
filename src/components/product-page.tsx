import { ComingSoonBadge, ComingSoonBanner } from "./coming-soon";
        ...
        <div className="mx-auto w-full max-w-[1120px] px-5 pt-16 pb-16 sm:px-8 sm:pt-24 sm:pb-20 lg:px-12 lg:pt-28 lg:pb-24">
          ...
          <div className="mt-4 grid gap-10 lg:grid-cols-12 lg:gap-12">
            <div className="lg:col-span-7">
              ...
              {soon ? <ComingSoonBanner name={product.name} /> : null}
              <div className="mt-10 flex flex-wrap items-center gap-x-8 gap-y-4">
                <CtaLink href={demoHref}>{soon ? copy.cta.talk : copy.cta.primary}</CtaLink>
      ...
      <Section tone="ticket">
        <div className="grid gap-10 lg:grid-cols-12 lg:gap-12">
          <h2 className="text-h2 lg:col-span-5">
            {product.capabilitiesTitle ?? (soon ? "What it will do" : "What you can do")}
          </h2>
          <div className="lg:col-span-7">
